...
def setup_logger(checkpoint_path: str) -> str:
    ...
    # Use a clean format so the ASCII table looks good in the log file
    formatter = logging.Formatter('%(message)s')

    # File Handler (Overwrites old eval logs)
...
def evaluate_checkpoint(
    ...
    # Pass cfg=None to use internal defaults. Initialize with a safe default trajectory.
    ...
    try:
        ...
        for traj in trajectories:
            ...
            for ep in range(episodes_per_traj):
                # Using the options dictionary to hot-swap trajectories!
...
def save_and_print_results(results: List[Dict], checkpoint_path: str):
    ...
    # Print Summary Table using logging.info
    logging.info("\n" + "="*85)
...
if __name__ == "__main__":
    ...
    # --- UPDATED: Now includes the spline curriculum ---
    # TEST_TRAJECTORIES = [
    #     "square", 
    #     "triangular", 
    #     "sawtooth", 
